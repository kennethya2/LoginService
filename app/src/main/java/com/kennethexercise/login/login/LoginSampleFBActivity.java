...
/**
 * Created by kennethyeh on 2016/10/24.
 */

public class LoginSampleFBActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_sample_fb_layout);
        mContext = this;
...
//	        		Log.d(TAG,"currentAccessToken:"+currentAccessToken.toString());
    ...
    private void setDefautLoginBTN(){
        mLoginButton = (LoginButton) findViewById(R.id.fbDefaultLogin);
...
//                leaveActivity();
    ...
    private void doLogin(){
        ...
        LoginManager.getInstance().logInWithReadPermissions(LoginSampleFBActivity.this,  Arrays.asList("public_profile", "email", "user_friends"));
    }

    private void leaveActivity(){
        LoginSampleFBActivity.this.finish();
    }
